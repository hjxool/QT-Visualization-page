...
export const http请求: http请求 = function (param1: string, param2?: object | string, param3?: object, param4?: object): Promise<any> {
  let options: any = {}
  ...
  return fetch(param1, options).then(res => res.json)
}
